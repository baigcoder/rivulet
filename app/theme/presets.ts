...
/** The colour the "Your colour" themes start from — electric cyan. */
export const DEFAULT_SOURCE = '#6FE3FF'
...
const TABLE = {
  ...
  /**
   * Rivulet Dark — Editorial direction: neutral-ink ground (#0E0F11), surface (#16181B),
   * electric cyan primary (#6FE3FF), and warm amber tertiary (#FFC978).
   */
  dark: {
    title: 'Rivulet Dark',
    dark: true,
    ...
    colors: {
      ...
      'primary': '#6FE3FF',
      'on-primary': '#003644',
      'primary-container': '#004e61',
      'on-primary-container': '#bceeff',
      'surface-tint': '#6FE3FF',
      'tertiary': '#FFC978',
      'on-tertiary': '#442b00',
      'tertiary-container': '#624000',
      'on-tertiary-container': '#ffddb2',
    },
    backdrop: { mode: 'custom', image: '/backgrounds/rivulet-dark.svg' },
  },
  ...
  /**
   * Rivulet Light — Editorial direction: light surface (#F7F8F9), white ground (#FFFFFF),
   * primary teal (#0E6C82), and electric cyan inverse-primary (#6FE3FF).
   */
  light: {
    title: 'Rivulet Light',
    dark: false,
    ...
    colors: {
      ...
      'primary': '#0E6C82',
      'on-primary': '#ffffff',
      'primary-container': '#bceeff',
      'on-primary-container': '#001f28',
      'inverse-primary': '#6FE3FF',
      'surface-tint': '#0E6C82',
      'error': '#ba1a1a',
      'on-error': '#ffffff',
    ...
    backdrop: { mode: 'custom', image: '/backgrounds/rivulet-light.svg' },
  },
