...
<template>
  <nuxt-link
    ...
    @blur="hover = false"
  >
    <div class="relative aspect-2/3 overflow-hidden rounded-lg bg-surface-container border border-outline-variant/40">
      <media-poster
      ...
      <div class="pointer-events-none absolute inset-0 rounded-lg opacity-0 ring-2 ring-inset ring-primary transition-opacity duration-150 group-hover:opacity-100 group-focus-visible:opacity-100" />
    </div>
