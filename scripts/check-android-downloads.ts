...
// the network is metered over the RivuletScreen bridge, and a method renamed on
...
assert.ok(platform.includes('RivuletScreen'), 'through the interface MainActivity registers')
assert.ok(activity.includes('"RivuletScreen"'), 'under that name')
